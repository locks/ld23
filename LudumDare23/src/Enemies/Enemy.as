package Enemies 
{
	...
	{
		[Embed(source = '../data/assault.png')] private var ImgEnemy:Class;
		[Embed(source = '../data/assault-animated.png')] private var ImgEnemyShooting:Class;
		[Embed(source = '../data/jets.png')] private var ImgJet:Class;
    ...
    public function init(xPos:int,yPos:int,Bullets:FlxGroup,Gibs:FlxEmitter,ThePlayer:Ship):void
    {
      _player = ThePlayer;
      _bullets = Bullets;
      _gibs = Gibs;
